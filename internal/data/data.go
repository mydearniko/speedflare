...
type Server struct {
	...
	Distance    float64 `json:"distance,omitempty"` // Distance from the estimated user location in km
	HasDistance bool    `json:"-"`                  // Whether Distance is based on a user-location estimate
}
